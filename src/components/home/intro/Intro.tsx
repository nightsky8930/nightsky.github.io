  ...
  return (
    <div>
      ...
      <div className="flex-grow flex flex-row items-center py-4 max-md:py-2">
        <Link
          to="/test-page"
          className="flex-grow flex bg-customGreenBlue hover:bg-sky-400 items-center justify-center rounded-full text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline"
        >
          Locate Us
        </Link>
      </div>
